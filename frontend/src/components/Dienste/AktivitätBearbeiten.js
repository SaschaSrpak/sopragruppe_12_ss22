...
/** 
 *@fileOverview Hier werden Aktivitäten bearbeitet / Editiert
 *@author LKiam Wilke
*/


// Komponente für den Dialog zum Bearbeiten einer Aktivität
export class AktivitätBearbeiten extends Component {
  ...
  // ändert den Status der Personentage
  onChangeManday = (e) => {
    this.setState({ manday: e.target.value });
  }
  // ändert den Status des Namens
  onChangeName = (e) => {
    this.setState({ name: e.target.value });
  }
  // Funktion um eine Aktivität zu aktualisieren
  updateActivity = () => {
  ...
  // Rendert die Seite zum Bearbeiten einer Aktivität
  render() {
